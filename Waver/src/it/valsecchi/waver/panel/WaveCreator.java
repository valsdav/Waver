...
public class WaveCreator extends JFrame {
	...
	private void initComponent() {
		...
		btnNewOnda.addActionListener(new WaveAdd());
		...
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(
				...
				gl_contentPane
						...
						.addComponent(btnNewOnda)
						.addGap(18)
						.addComponent(panel, GroupLayout.PREFERRED_SIZE, 107,
								GroupLayout.PREFERRED_SIZE)
						.addGap(18)
						.addComponent(panel_1, GroupLayout.PREFERRED_SIZE, 445,
								GroupLayout.PREFERRED_SIZE)
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(
				...
				gl_panel.createSequentialGroup()
						...
						.addComponent(txtAmpiezza, GroupLayout.PREFERRED_SIZE,
								69, GroupLayout.PREFERRED_SIZE)
						.addGap(18)
						.addComponent(lblPeriodo, GroupLayout.PREFERRED_SIZE,
								60, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtPeriodo, GroupLayout.PREFERRED_SIZE,
								69, GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addComponent(lblLunghezzaDonda)
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addComponent(txtLambda, GroupLayout.PREFERRED_SIZE,
								69, GroupLayout.PREFERRED_SIZE)
						.addGap(24)
						.addComponent(lblFaseIniziale,
								...
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(txtFase0, GroupLayout.PREFERRED_SIZE, 69,
								GroupLayout.PREFERRED_SIZE)));
	...
	private class WaveAdd implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent arg0) {
			// si crea una nuova onda
			...
			// si aggiunge
			String id = getCounter();
			waves.put(id, wave);
			// si aggiunge ai listeners
			for (WaveManager m : listeners) {
				m.addWaveFormula(id, wave);
			}
		}
	}

	public void addWaveManager(WaveManager lis) {
		listeners.add(lis);
	}
